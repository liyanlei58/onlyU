...
module.exports = {
  ...
  formatGender: function(userInfo, callback) {
    if (userInfo.gender != null && userInfo.gender == false) {
      userInfo.gender = Const.Gender.Female.VALUE;
    } else {
      userInfo.gender = Const.Gender.Male.VALUE;
    }
    // if (userInfo.car != null && userInfo.car == true) {
    //   userInfo.car = Const.Car.Have.VALUE;
    // } else {
    //   userInfo.car = Const.Car.No.VALUE;
    // }
    callback(userInfo);
  },
